...
| `opened_on` | `DATE` | NULL | The account's "Start Date" (the opening balance's as-of date). MD records it for every account type; seeded from MD on import, editable in Coffer later. Added in migration 127 (ADR-0050). |

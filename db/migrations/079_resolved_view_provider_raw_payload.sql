-- =============================================================================
-- 079 — resolved_transactions view exposes provider_raw_payload
-- =============================================================================
--
-- Project the txn_headers.provider_raw_payload column added by
-- migration 078 through the read-side view so the SPA's right-click
-- "Show raw provider data" surface can display it without an extra
-- fetch.
--
-- security_invoker = true re-asserted per the migration 057 / 077
...
SELECT l.id,
    ...
    -- ADR-0031 follow-up (migration 078): original provider JSON for
    -- diagnostic / classifier-iteration purposes.
